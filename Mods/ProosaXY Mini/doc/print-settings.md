...
Certain pieces like the LCD holder needs to remove the printable support.


![](assets/20260424_180508_Proosa_mini_lcd_support.jpg)
...
| XY Axis | MINI     | y-carrier-cap-LM10**L**UU     | 2      | Take care, LM10LUU for long bearing.                                  |
| XY Axis | MINI     | y-carrier-LM10**L**UU         | 2      | Take care, LM10LUU for long bearing.                                  |
| XY Axis | MINI     | y-rod-cap-10mm                | 4      |                                                                       |
| XY Axis | ProosaXY | long-spacer                   | 2      |                                                                       |
| XY Axis | ProosaXY | short-spacer                  | 8      |                                                                       |
| XY Axis | MINI     | rod-mount-10mm                | 4      |                                                                       |
...
| Panels  | MINI     | bottom-panel-back-left        | 1      |                                                                       |
...
| Panels  | MINI     | cable-panel-back-cover        | 1      |                                                                       |
| Panels  | MINI     | cable-panel-back-cover-mirror | 1      |                                                                       |
| Panels  | MINI     | cable-panel-bottom-cover      | 1      |                                                                       |
| Panels  | ProosaXY | bottom-back-panel-connector   | 4      |                                                                       |
...
| Tools | ProosaXY | bearing-stack-holder-tool | 1      | Needed to fit the F623 bearing stacks                              |
